...
- Fixed asynchronous run persistence to use explicit-parent cursors without stealing the selected leaf, and reject malformed tool-call/result paths locally before provider requests.
