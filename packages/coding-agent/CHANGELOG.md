...
- Added awaitable extension user-message delivery results so `pi.sendUserMessage()` and replacement-session contexts report whether input started, was handled, was queued, or failed.
